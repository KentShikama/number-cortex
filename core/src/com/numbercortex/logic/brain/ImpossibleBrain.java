...
class ImpossibleBrain implements Brain {
    ...
    private int getSafestNumber(ArrayList<Integer> safeNumbers, Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> availableNumbers) {
        int safestNumber;
        ArrayList<Integer> openCoordinates = BoardUtilities.getOpenCoordinates(coordinateNumberMap);
    ...
    private int calculatePoints(Integer safeNumber, Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> availableNumbers, ArrayList<Integer> openCoordinates) {
        int points = 0;
        ...
        for (Integer openCoordinate : openCoordinates) {
            ...
            ArrayList<Integer> safeNumbersOpponentCanChoose = utility.getSafeNumbersIfExistent(coordinateNumberMap, availableNumbers);
    ...
    private boolean checkIfSafe(Integer possibleNextNumber, Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> newAvailableNumbers) {
        boolean safe = false;
    ...
    private int updateSafestNumberListAndMaxPoints(Integer safeNumber, int points, ArrayList<Integer> safestNumberList, int maxPoints) {
        if (points > maxPoints) {
            maxPoints = points;
