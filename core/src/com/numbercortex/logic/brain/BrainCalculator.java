...
class BrainCalculator {
    ...
    int assignWinningCoordinateIfExistent(int chosenNumber, Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> openCoordinates) {
    ...
    ArrayList<Integer> getNonWinningCoordinatesIfExistent(int chosenNumber, Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> openCoordinates) {
    ...
    ArrayList<Integer> getSafeCoordinatesIfExistent(int chosenNumber, Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> openCoordinates, ArrayList<Integer> availableNumbers) {
    ...
    ArrayList<Integer> getSafeNumbersIfExistent(Map<Integer, Integer> coordinateNumberMap, ArrayList<Integer> availableNumbers) {
