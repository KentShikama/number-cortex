...
abstract class HomeScreen extends GameScreen {
    class HomeScreenButton extends Group {
        ...
        private void addArmature(ClickListener listener, int index, TextureRegion buttonBoxTexture) {
            ...
            buttonBackground.setBounds(175, Launch.SCREEN_HEIGHT - (FIRST_BUTTON_CENTER_OFFSET_Y + index * 80), buttonBoxTexture.getRegionWidth(), buttonBoxTexture.getRegionHeight());
    ...
    private void buildTitle(Stage stage) {
        ...
        title.setBounds(63, Launch.SCREEN_HEIGHT - (FIRST_BUTTON_CENTER_OFFSET_Y - 74), titleTexture.getRegionWidth(), titleTexture.getRegionHeight());
    ...
    private void buildLineExtension(Stage stage) {
        ...
        lineExtension.setBounds(175, Launch.SCREEN_HEIGHT - (FIRST_BUTTON_CENTER_OFFSET_Y + 280), lineExtensionTexture.getRegionWidth(), lineExtensionTexture.getRegionHeight());
