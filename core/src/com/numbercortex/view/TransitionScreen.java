...
class TransitionScreen extends GameScreen {
    ...
    private void transition(Direction direction, final GameScreen currentScreen, final GameScreen nextScreen, final float duration) {
    ...
    private void animateCurrentScreenAndSwitchScreens(Direction direction, final GameScreen currentScreen, final GameScreen nextScreen, final float duration) {
    ...
    private ParallelAction buildCurrentScreenAnimationWithSliding(Direction direction, final GameScreen currentScreen, final GameScreen nextScreen, final float duration) {
