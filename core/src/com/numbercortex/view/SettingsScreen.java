...
abstract class SettingsScreen extends GameScreen {
    ...
    void addSingleDouble(GroupState state) {
        ...
        CheckboxSettingGroup singleDoubleGroup = new CheckboxSettingGroup(singleDoubleLabel, singleDoubleCheckbox, state);
    ...
    void addDiagonalsGroup(GroupState state) {
        ...
        CheckboxSettingGroup diagonalsGroup = new CheckboxSettingGroup(diagonalsLabel, diagonalsCheckbox, diagonalsIcon, state);
