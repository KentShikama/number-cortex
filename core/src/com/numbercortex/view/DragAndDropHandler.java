...
public class DragAndDropHandler {
    ...
    class NumberSource extends Source {
        ...
        private boolean isValidToDrag() {
            return messenger != null && isChosenNumber(sourceButton) && Persistence.getInstance().isInPlay() && isFirstPlacementForTutorialLevel(sourceButton) && isPlacementCountUnderMaximum();
        }
